...
import com.simpl.pay.sample.zc.utils.Decompression;
...
public class FingerprintTestSuite {
    ...
    private void assertDefaults() {
        try {
            ...
            assertEquals(object.getString("sdk-version"), com.simpl.android.zeroClickSdk.BuildConfig.VERSION_NAME);
            assertEquals(object.getString("sdk"), "zc");

...
public class Urls_Test {
    ...
    private static final String BASE_URL_STAGING = "https://api.stagingsimpl.com/api/v1";
    ...
    public static final String OTP_BY_VERIFICATION_ID = getBaseURL() + "/integration_test/otp_by_verification_id?verification_id=";
